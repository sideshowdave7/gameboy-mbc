#
# Project automation script for Gameboy MBC
#
# Created for ISE version 14.7
#
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source Mojo-Base.tcl), then you can
...
set myProject "MBC1"
set myScript "MBC1.tcl"

set compile_directory output
...
proc set_process_props {} {
   ...
   project set "Output File Name" "pwm_top" -process "Generate IBIS Model"
